...
<div class="e1">
    ...
    <span>
        <img src="TODOimage.png" style="width:22%" alt="eventName" id="i1"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i2"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i3"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i4">
    </span><br>
    <span class="rescind">
    ...
    <span>
        <img src="TODOimage.png" style="width:22%" alt="eventName" id="i5"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i6"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i7"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i8">
    </span><br>
    ...
    <span>
        <img src="TODOimage.png" style="width:22%" alt="eventName" id="i9"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i10"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i11"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i12">
    </span><br>
    <span class="rescind" style="width:20%">
    ...
    <span>
        <img src="TODOimage.png" style="width:22%" alt="eventName" id="i13"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i14"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i15"><img src="TODOimage.png" style="width:22%" alt="eventName" id="i16">
    </span><br>
    <span class="rescind" style="width:20%">
