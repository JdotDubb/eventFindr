   ...
   <body>
      ...
      <div class="col-md-4">
         <div class="card mb-4 box-shadow">
            <img class="card-img-top" img src="resources/friends1.jpg" alt="Card image cap">
            <div class="card-body">
               <h1>Host events of your own</h1>
               <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                     <!-- Trigger/Open The Modal -->
                     <a href="host" id="myBtn" class="add-event">Host</a>
                     <!-- The Modal -->
      ...
      <div class="col-md-4">
         <div class="card mb-4 box-shadow">
            <img class="card-img-top" img src="resources/queen.jpg" alt="Card image cap">
            <div class="card-body">
               <h1>Discover events in Charlotte</h1>
               <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                     <!-- Trigger/Open The Modal -->
                     <a href="discover" id="myBtn" class="add-event">Discover</a>
                     <!-- The Modal -->
                     <div id="myModal" class="modal">
                        <!-- Modal content -->
                        <div class="modal-content">
      ...
      <div class="col-md-4">
         <div class="card mb-4 box-shadow">
            <img src="resources/join.png" alt="Card image cap">
            <div class="card-body">
               <h1>Join events here on eventFindr</h1>
               <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                     <!-- Trigger/Open The Modal -->
                     <a href="join" id="myBtn" class="add-event">Join</a>
                     <!-- The Modal -->
                     <div id="myModal" class="modal">
                        <!-- Modal content -->
                        <div class="modal-content">
