<html>
   ...
   <body>
      ...
      <div class="il">
         <span>
         <button style="width:22%" onclick="load()" id="b1">See more about Event Name</button><button style="width:22%" onclick="load()" id="b2">See more about Event Name</button><button style="width:22%" onclick="load()" id="b3">See more about Event Name</button><button style="width:22%" onclick="load()" id="b4">See more about Event Name</button>
         </span><br>
         <span>
      ...
      <div class="il">
         <span>
         <button style="width:22%" onclick="load()" id="b5">See more about Event Name</button><button style="width:22%" onclick="load()" id="b6">See more about Event Name</button><button style="width:22%" onclick="load()" id="b7">See more about Event Name</button><button style="width:22%" onclick="load()" id="b8">See more about Event Name</button>
         </span><br>
         <span>
      ...
      <div class="il">
         <span>
         <button style="width:22%" onclick="load()" id="b9">See more about Event Name</button><button style="width:22%" onclick="load()" id="b10">See more about Event Name</button><button style="width:22%" onclick="load()" id="b11">See more about Event Name</button><button style="width:22%" onclick="load()" id="b12">See more about Event Name</button>
         </span><br>
         <span>
      ...
      <div class="il">
         <span>
         <button style="width:22%" onclick="load()" id="b13">See more about Event Name</button><button style="width:22%" onclick="load()" id="b14">See more about Event Name</button><button style="width:22%" onclick="load()"id="b15">See more about Event Name</button><button style="width:22%" onclick="load()" id="b16">See more about Event Name</button>
         </span><br>
         <span>
