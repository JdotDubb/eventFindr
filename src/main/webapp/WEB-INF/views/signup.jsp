...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="/action_page.php">
    <div class="container">
      ...
      <p>By creating an account, I accept eventFindr <a href="/eventFindr/policy" style="color:dodgerblue">Terms of Service, Code of Conduct</a> and have read the <a href="/eventFindr/policy" style="color:dodgerblue"> Privacy Policy</a>.</p>
