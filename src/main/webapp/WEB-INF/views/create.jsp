  ...
  .column, input[type=submit] {
   ...
   <body>
      ...
      <div class="jumbotron text-center">
         <h1>Create</h1>
         <p>Fill in the required information to create an event.</p>
      </div>
      <div class="container">
  			<div class="row">
    			...
    			<div class="column">
      				<form action="/action_page.php">
        				...
        				<input type="text" id="ename" name="eventname" placeholder="Your event name..">	
        				...
        				<input type="text" id="venue" name="venue" placeholder="location is at..">
